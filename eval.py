...
tf.flags.DEFINE_string("checkpoint_dir", "./runs/2017-11-28T09:12:15.017009/checkpoints/", "Checkpoint directory from training run")
...
tf.flags.DEFINE_string("eval_device", '/gpu:2', "Witch device use to train")
